...
left join panther_upl.go_annotation_qualifier_new gaq on gaq.annotation_id = gan.annotation_id and gen.annotation_qualifier_id = gaq.annotation_qualifier_id
